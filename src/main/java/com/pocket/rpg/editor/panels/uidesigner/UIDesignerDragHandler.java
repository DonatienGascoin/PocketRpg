...
/**
 * Handles all drag operations in the UI Designer: move, resize, anchor, and pivot dragging.
 * Also manages undo capture/commit and edge snapping.
 */
public class UIDesignerDragHandler {

    private final UIDesignerState state;
    private final UIDesignerCoordinates coords;
    private final EditorContext context;

    public UIDesignerDragHandler(UIDesignerState state, UIDesignerCoordinates coords, EditorContext context) {
        this.state = state;
        this.coords = coords;
    ...
    public void startMoveDrag(EditorGameObject entity, float canvasX, float canvasY) {
    ...
    public void startResizeDrag(EditorGameObject entity, UIDesignerState.ResizeHandle handle) {
    ...
    public void startAnchorDrag(EditorGameObject entity) {
    ...
    public void startPivotDrag(EditorGameObject entity) {
    ...
    public void handleDragInput() {
        if (ImGui.isMouseDragging(imgui.flag.ImGuiMouseButton.Left)) {
