...
public class ShortcutContext {
     ...
     * Note: This basic version only handles global/popup state.
     * For panel-scoped shortcuts, use ShortcutContextBuilder.
     */
    public static ShortcutContext current() {
        return builder()
                .popupOpen(ImGui.isPopupOpen("", ImGuiPopupFlags.AnyPopup))
    ...
    public static class Builder {
        ...
        public Builder panelFocused(String panelId) {
            ...
            this.visiblePanels.add(panelId); // Focused implies visible
            return this;
        }
