...
public class ShortcutBinding {
    ...
    public static ShortcutBinding shiftAlt(int key) {
        return new ShortcutBinding(key, false, true, true);
    }
    ...
    private static String getKeyName(int key) {
        ...
        return switch (key) {
            ...
            case ImGuiKey.KeypadAdd -> "Num+";
            case ImGuiKey.KeypadSubtract -> "Num-";
            case ImGuiKey.KeypadMultiply -> "Num*";
            case ImGuiKey.KeypadDivide -> "Num/";
            case ImGuiKey.KeypadEnter -> "NumEnter";
            default -> "Key" + key;
        };
    }
    ...
    private static int parseKeyName(String name) {
        ...
        return switch (name.toLowerCase()) {
            ...
            case "\\" -> ImGuiKey.Backslash;
            case "`" -> ImGuiKey.GraveAccent;
            case "num+", "numpad+" -> ImGuiKey.KeypadAdd;
            case "num-", "numpad-" -> ImGuiKey.KeypadSubtract;
            case "num*", "numpad*" -> ImGuiKey.KeypadMultiply;
            case "num/", "numpad/" -> ImGuiKey.KeypadDivide;
            case "numenter" -> ImGuiKey.KeypadEnter;
            default -> -1;
        };
    }
